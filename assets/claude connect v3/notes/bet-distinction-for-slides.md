...
See **connect-with-a-purpose-slides.md** for the current three-slide version, including Google/Microsoft/Unknown personalization. The notes below preserve the portfolio distinction and earlier scoping considerations.
